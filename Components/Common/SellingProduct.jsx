        ...
        <div className="sellingProductContent rounded ">
          ...
          <div className="buyBtnDiv">
            ...
            <div className="d-flex">
              <button
                className={`btn btn-md rounded-1 border icon-prod ${count?.wish_product_id?.includes(item?.id?.toString())
                    ? "active"
                    : ""
                  }`}
                onClick={
              ...
              <button
                className={`btn btn-md rounded-1 border icon-prod ms-2 ${count?.cart_product_id?.includes(item?.id?.toString())
                    ? "active"
                    : ""
                  }`}
