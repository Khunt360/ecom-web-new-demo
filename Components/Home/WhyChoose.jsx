      ...
      <div className="chose-right">
        ...
        <div className="chs-box">
          <div className="chs-item">
            <Image
        loading='lazy'
        unoptimized  src={BASE_URL + footerData?.image1} alt="item1" />
            <p>{footerData?.why_buy_point3}</p>
          </div>
          <div className="chs-item">
            <Image
        loading='lazy'
        unoptimized  src={BASE_URL + footerData?.image2} alt="item1" />
            <p>{footerData?.why_buy_point4}</p>
          </div>
          <div className="chs-item">
            <Image
        loading='lazy'
        unoptimized  src={BASE_URL + footerData?.image3} alt="item1" />
